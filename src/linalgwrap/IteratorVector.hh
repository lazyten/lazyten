...
template <typename Iterator, typename ConstIterator>
IteratorVector<Iterator, ConstIterator>&
IteratorVector<Iterator, ConstIterator>::operator*=(scalar_type s) {
    assert_finite(s);
...
IteratorVector<Iterator, ConstIterator>&
IteratorVector<Iterator, ConstIterator>::operator+=(
      const IteratorVector<Iterator, ConstIterator>& other) {
...
template <typename T, typename CT>
IteratorVector<T*, CT>& IteratorVector<T*, CT>::operator+=(
      const IteratorVector& other) {
    assert_size(this->n_elem(), other.n_elem());
