...
class ApplyElementwiseIterator
 ...
 public:
  ...
  //@{
  bool operator==(const inner_iterator_type& other) const { return m_inner == other; }
  bool operator!=(const inner_iterator_type& other) const { return !(*this == other); }
...
class ApplyElementwiseContainer {
 public:
  ...
  ApplyElementwiseContainer(const Indexable& i, Operation op_)
        : inner_ptr{"ApplyElementwiseContainer", i}, op(std::forward<Operation>(op_)) {}
  ...
  const_iterator cbegin() const { return const_iterator{inner_ptr->begin(), op}; }
...
class ApplyElementwise : public Indexable_i<ApplyElementReturnT<Indexable, Operation>>,
 ...
 public:
  ...
  size_type n_elem() const override { return container_type::inner_ptr->n_elem(); }
...
typename ApplyElementwiseIterator<Indexable, Operation>::pointer
  ...
  assert_dbg(false, krims::ExcDisabled("Getting a pointer to an element, which "
