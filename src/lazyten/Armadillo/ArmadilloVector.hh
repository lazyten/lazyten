...
/** A class for an armadillo column vector with the interface of lazyten */
namespace lazyten {
...
class ArmadilloVector : public MutableMemoryVector_i<Scalar>, public Stored_i {
 ...
 public:
  ...
  explicit ArmadilloVector(std::initializer_list<Scalar> list) : m_arma(list) {}

  /** \brief Construct from std::vector */
  explicit ArmadilloVector(std::vector<scalar_type> v) : m_arma(std::move(v)) {}
...
typename std::common_type<Scalar1, Scalar2>::type dot(const ArmadilloVector<Scalar1>& A,
                                                      const ArmadilloVector<Scalar2>& B) {
...
// -- norms
template <typename Scalar>
typename ArmadilloVector<Scalar>::real_type norm_l1(const ArmadilloVector<Scalar>& A) {
  return arma::norm(A.data(), 1);
}

template <typename Scalar>
typename ArmadilloVector<Scalar>::real_type norm_linf(const ArmadilloVector<Scalar>& A) {
...
template <typename Scalar>
typename ArmadilloVector<Scalar>::real_type norm_l2(const ArmadilloVector<Scalar>& A) {
